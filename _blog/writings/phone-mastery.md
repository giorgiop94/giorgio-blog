...
***On iPhone:*** to select which notifications you want to see on your lockscreen and which ones you don’t go to Settings → Notifications → Select an app → Click on Lockscreen to disable it (blue badge
disappears).
